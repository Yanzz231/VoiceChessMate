  ...
  if (color === "#000000") {
    return (
      <Svg width={width} height={height} viewBox="-50 -60 381.3 511.7">
        ...
        <Path
          fill="#fff"
          d="M180.4 29.8a34.8 34.8 0 1 1-69.7 0 34.8 34.8 0 0 1 69.7 0"
        />
        <Path
          fill="none"
          stroke="#000"
          ...
          stroke-width="30"
          d="M180.4 29.8a34.8 34.8 0 1 1-69.7 0 34.8 34.8 0 0 1 69.7 0Zm0 0"
        />
        <Path
          fill="#ccc"
          d="M248.1 149.9C191.6 165.2 154 261.3 154 261.3s4.7-86.5 44.8-160.1c-27.9-22.3-52.6-36-52.6-36s-132 72-131.1 154.6c1 82.6 66.2 147 58 164.3-8 17.2 154.3 16.3 146.1 0-8.1-16.4 56.3-82.6 57.2-164.3.3-24.7-11.5-48.6-28.2-70"
        />
        <Path
          fill="#fff"
          d="M150.3 71.8c-50.5 87-62.5 126-62.5 153 0 56.9 51 148 26.5 162h-36l-45-90-18-63 9-54 36-45Zm0 0"
        />
        ...
        <Path
          ...
          stroke-miterlimit="10"
          stroke-width="30"
          d="M47.3 324.3c15.6 24.3 181.5 28.8 198 0"
        />
      </Svg>
    );
  } else {
