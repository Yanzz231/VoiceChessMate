...
export const PawnV3 = ({ width = 192, height = 192, color = "#000000" }) => {
  return (
    <Svg width={width} height={height} viewBox="0 0 512 512">
      <G>
        <Path
          d="M256,161.408c44.568,0,80.71-36.13,80.71-80.698C336.71,36.142,300.567,0,256,0
            c-44.568,0-80.698,36.142-80.698,80.71C175.302,125.278,211.431,161.408,256,161.408z"
          fill={color}
        />
        <Path
          d="M113.114,431.973h285.783c0,0,16.267-3.756,16.267-22.57c0-28.216-50.702-46.641-63.92-56.664
