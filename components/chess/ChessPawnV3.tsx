...
export const PawnV3 = ({ width = 192, height = 192, color = "#000000" }) => {
  if (color !== "#000000") {
    return (
      <Svg width={width} height={height} viewBox="-50 -100 345.8 506.5">
        <Defs>
          <ClipPath id="a">
        ...
        <Path
          fill="#ccc"
          d="M239.5 320.4c0-90.3-74.4-119.9-65.9-176.2A81 81 0 0 0 129.3-3.7a81.2 81.2 0 0 0-48.2 147.8c9.5 56.4-64.8 86.4-64.8 176.3 33 9.9 54.4 19.7 112.2 19.7s78-9.8 111-19.7"
        />
        <Path
          fill="#fff"
          d="M126 10.4s-25 26-26 64c-1 38.1 14 60.6 14 66 0 5.5.4 28.4-5 48s-36 89-34 136c1.4 32.8-55.6-10.4-55.6-10.4l7.6-56.6 56.6-82.6-4.3-34.9-33.8-52.2 19.6-62Zm0 0"
        />
