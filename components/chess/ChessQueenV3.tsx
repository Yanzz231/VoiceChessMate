  ...
  if (color !== "#000000") {
    return (
      <Svg width={width} height={height} viewBox="-50 -90 498 528">
        <Path
          fill="#ccc"
          d="M319.3 373H88.7a79.8 79.8 0 0 0 17.7-49.5c0-7-1-28.7-17.7-49.5h230.6a79.8 79.8 0 0 0-17.7 49.5c0 7 1 28.7 17.7 49.5"
        />
        <Path
          fill="#fff"
          d="M140 373c3.6-10.3 11.4-25.8 12-45 .7-23.8-8.1-41.7-12-53-10.7 0-27.3-1-38-1l15.6 54L93 373Zm0 0"
        />
        ...
        <Path
          fill="#ccc"
          d="m91.1 234.3-35.4-127c3.3 2 50.5 69 74.2 54.2 18.8-11.8 14.9-84.2 16.4-112.5 8.3 26.2 36.1 93.8 57.7 93.8s49.4-67.6 57.7-93.8c.5 3.2-7.9 97.2 24.7 112.5 18.6 8.8 59.9-51.5 65.9-54.2-6.2 35.2-28.8 83.8-35 126.8a46.2 46.2 0 0 1-45.5 39.9H136.6A46.1 46.1 0 0 1 91 234.3"
        />
        <Path
          fill="#fff"
          d="M86.8 139C153 172 93 259 230 259l-100 15a148.2 148.2 0 0 1-43.2-72c-6.6-27-3.2-49.7 0-63"
        />
        ...
        <Path fill="#f2f2f2" d="M168 22a27 27 0 1 1-54 0 27 27 0 0 1 54 0" />
        <Path
          fill="none"
          stroke="#000"
          ...
          stroke-width="30"
          d="M168 22a27 27 0 1 1-54 0 27 27 0 0 1 54 0Zm0 0"
        />
        <Path fill="#f2f2f2" d="M294 22a27 27 0 1 1-54 0 27 27 0 0 1 54 0" />
        <Path
          fill="none"
          stroke="#000"
          stroke-linejoin="round"
          stroke-miterlimit="10"
          stroke-width="30"
          d="M294 22a27 27 0 1 1-54 0 27 27 0 0 1 54 0Zm0 0"
        />
        <Path fill="#f2f2f2" d="M393 76a27 27 0 1 1-54 0 27 27 0 0 1 54 0" />
        <Path
          fill="none"
          stroke="#000"
          stroke-linejoin="round"
          stroke-miterlimit="10"
          stroke-width="30"
          d="M393 76a27 27 0 1 1-54 0 27 27 0 0 1 54 0Zm0 0"
        />
        <Path fill="#f2f2f2" d="M69 76a27 27 0 1 1-54 0 27 27 0 0 1 54 0" />
        <Path
          fill="none"
          stroke="#000"
          stroke-linejoin="round"
          stroke-miterlimit="10"
          stroke-width="30"
          d="M69 76a27 27 0 1 1-54 0 27 27 0 0 1 54 0Zm36.2 252h197.6"
        />
      </Svg>
    );
  } else {
