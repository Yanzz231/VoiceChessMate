...
export const KingV3 = ({ width = 192, height = 192, color = "#000000" }) => {
  return (
    <Svg width={width} height={height} viewBox="0 0 512 512">
      <G>
        <Path
          d="M243.358,82.765h25.27c0,0-1.722-18.991-1.722-29.826c10.817,0,31.13,3.087,31.13,3.087V28.034
        ...
        />
        <Path
          d="M202.818,227.026h106.365c0,0,18.766-52.278,25.027-79.217c2.139-9.244-6.261-20.592-20.348-20.592
        ...
        />
        <Path
          d="M331.253,375.087c-27.026-43-29.357-86.217-29.357-86.217h-91.809c0,0-2.33,43.217-29.339,86.217
        ...
        />
        <Path
          d="M311.392,241.165H200.61c0,8.392-8.087,14.391-16.157,19.183c-8.087,4.8-6.069,14.391,0,14.391h143.096
        ...
        />
        <Polygon
          points="154.626,469.07 143.531,487.774 143.531,512 368.47,512 368.47,487.774 357.357,469.07"
          fill={color}
        />
      </G>
    </Svg>
