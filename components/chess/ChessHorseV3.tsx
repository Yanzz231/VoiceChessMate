...
export const HorseV3 = ({ width = 192, height = 192, color = "#000000" }) => {
  if (color !== "#000000") {
    return (
      <Svg width={width} height={height} viewBox="-50 -92.5 398 510">
        <Defs>
          <ClipPath id="a">
        ...
        <Path
          ...
          stroke-width="30"
          d="M55 292a333 333 0 0 0 100.2 14.1 332.8 332.8 0 0 0 91.4-14"
        />
