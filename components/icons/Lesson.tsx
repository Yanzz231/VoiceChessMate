...
export const Lesson = ({ width = 192, height = 192 }) => {
  return (
    <Svg width={width} height={height} viewBox="0 0 829.491 591.977" role="img">
      <G
        id="Group_33"
        data-name="Group 33"
        transform="translate(-604.689 -291)"
      >
        <Rect
          id="Rectangle_127"
        ...
        <Path
          ...
          transform="translate(485.82 161)"
          opacity="0.1"
        />
        <Rect
          id="Rectangle_175"
        ...
        <G id="Michel" transform="translate(485.82 161)">
          ...
          <Path
            id="Path_482-6439"
            data-name="Path 482"
            d="M663.28,259.64l9.65,2.06-.95,2.54-9.1-2.67Z"
            fill="#3c354c"
          />
          <Path
            id="Path_483-6440"
            data-name="Path 483"
            d="M717.07,253.18l-8.9,4.29,1.53,2.24,8.21-4.75Z"
            fill="#3c354c"
          />
          <Path
            id="Path_484-6441"
            data-name="Path 484"
            d="M687.31,261.06l6.77-.81-.35,1.68-5.81.39Z"
            fill="#3c354c"
          />
          <Path
            id="Path_485-6442"
        ...
        <Path
          id="Path_486-6443"
          data-name="Path 486"
          d="M912.81,682c0,37.7,23.654,68.214,52.883,68.214"
          transform="translate(400.272 128.755)"
          fill="#46455b"
        />
        <Path
          id="Path_487-6444"
          data-name="Path 487"
          d="M983.28,749.97c0-38.13,26.4-68.98,59.022-68.98"
          transform="translate(378.686 127.556)"
          fill="#6c63ff"
        />
        <Path
          id="Path_488-6445"
          data-name="Path 488"
          d="M938.35,686.56c0,35.818,15.084,64.8,33.717,64.8"
          transform="translate(393.898 127.617)"
          fill="#6c63ff"
        />
        <Path
          id="Path_492-6446"
          data-name="Path 492"
          d="M148.31,711.36c0,26.8,16.794,48.446,37.554,48.446"
          transform="translate(621.38 116.255)"
          fill="#46455b"
        />
        <Path
          id="Path_494-6447"
          data-name="Path 494"
          d="M168.62,715c0,25.456,10.718,46.021,23.948,46.021"
          transform="translate(614.676 115.053)"
          fill="#6c63ff"
        />
        <Path
          id="Path_495-6448"
          data-name="Path 495"
          d="M204.37,740.911c0-28.011,17.545-50.681,39.222-50.681"
          transform="translate(602.874 135.149)"
          fill="#46455b"
        />
        <Rect
          id="Rectangle_125"
          ...
          width="719.503"
          height="2.904"
          transform="translate(714.677 876.074)"
          fill="#3f3d56"
        />
      </G>
    </Svg>
